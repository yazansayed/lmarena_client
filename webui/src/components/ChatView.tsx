  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
        ...
        {error && !sending && (
          <div className="flex justify-start">
            <div className="max-w-[80%] rounded-lg border border-red-800 bg-red-950/50 px-3 py-2 text-sm text-red-200 shadow-sm">
              <div className="mb-1 text-[10px] uppercase tracking-wide text-red-400">
                Error
              </div>
              <div>{error}</div>
            </div>
